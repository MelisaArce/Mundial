...
namespace Mundial
{
    public partial class semi : Form
    {
        ...
        private void semi_Load(object sender, EventArgs e)
        {
            LlenarGridSemi();
        }
        ...
        private void LlenarGridSemi()
        {
            ...
            {
                dgvSemi.DataSource = datos.DefaultView; //retorna a una lista el default es la vista por defecto de la base
            }
        ...
        private void ElegirPartido_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (ElegirPartido.SelectedIndex == 0) // PARTIDO [61]
            {
                //MOSTRAR PAISES
                ...
                equipoAleatorio2 = crudPartidos.DevuelveIDGanadorF(ganador2); //GANADOR 3
            ...
            if (ElegirPartido.SelectedIndex == 1) // PARTIDO [62]
            {
                string equipoAleatorio = "";
                string equipoAleatorio2 = "";


                equipoAleatorio = crudPartidos.DevuelveIDGanadorF(ganador3); //GANADOR 1
                ...
                equipoAleatorio2 = crudPartidos.DevuelveIDGanadorF(ganador4); //GANADOR 3
