...
namespace Mundial
{
    ...
    {
        cuartos ven_cuartos = new cuartos();
        ...
        void octavos_Load(object sender, EventArgs e)
        {
            llenarGridOctavos();
        }
        private void llenarGridOctavos()
        {

            DataTable datos = crudPartidos.posicionesOctavo();
            ...
            {
                dgvOctavos.DataSource = datos.DefaultView; //retorna a una lista el default es la vista por defecto de la base
            }
        ...
        public void GanaOpierdePenales()
        {
            ...
            if (id_partido == 49)
            {
                ...
                {
                    Partido partido = crudPartidos.DevuelveGrupoMAYOR(GrupoA);
                    crudPartidos.InsertarCuartos(partido);
                }
                else
                {
                    Partido partido = crudPartidos.DevuelveGrupoMENOR(GrupoB);
                    crudPartidos.InsertarCuartos(partido);
                }
            ...
            if (id_partido == 50)
            {
                ...
                if (Convert.ToInt32(cantPenales1.Text) > Convert.ToInt32(cantPenales2.Text)) //SI GANA
                {
                    Partido partido = crudPartidos.DevuelveGrupoMAYOR(GrupoC);
                    crudPartidos.InsertarCuartos(partido);
                }
                else
                {
                    Partido partido = crudPartidos.DevuelveGrupoMENOR(GrupoD);
                    crudPartidos.InsertarCuartos(partido);
            ...
            if (id_partido == 51)
            {
                ...
                if (Convert.ToInt32(cantPenales1.Text) > Convert.ToInt32(cantPenales2.Text)) //SI GANA
                {
                    Partido partido = crudPartidos.DevuelveGrupoMAYOR(GrupoB);
                    crudPartidos.InsertarCuartos(partido);
                }
                else
                {
                    Partido partido = crudPartidos.DevuelveGrupoMENOR(GrupoA);
                    crudPartidos.InsertarCuartos(partido);
            ...
            if (id_partido == 52)
            {
                ...
                if (Convert.ToInt32(cantPenales1.Text) > Convert.ToInt32(cantPenales2.Text)) //SI GANA
                {
                    Partido partido = crudPartidos.DevuelveGrupoMAYOR(GrupoD);
                    crudPartidos.InsertarCuartos(partido);
                }
                else
                {
                    Partido partido = crudPartidos.DevuelveGrupoMENOR(GrupoC);
                    crudPartidos.InsertarCuartos(partido);
            ...
            if (id_partido == 53)
            {
                ...
                if (Convert.ToInt32(cantPenales1.Text) > Convert.ToInt32(cantPenales2.Text)) //SI GANA
                {
                    Partido partido = crudPartidos.DevuelveGrupoMAYOR(GrupoE);
                    crudPartidos.InsertarCuartos(partido);
                }
                else
                {
                    Partido partido = crudPartidos.DevuelveGrupoMENOR(GrupoF);
                    crudPartidos.InsertarCuartos(partido);
            ...
            if (id_partido == 54)
            {
                ...
                if (Convert.ToInt32(cantPenales1.Text) > Convert.ToInt32(cantPenales2.Text)) //SI GANA
                {
                    Partido partido = crudPartidos.DevuelveGrupoMAYOR(GrupoG);
                    crudPartidos.InsertarCuartos(partido);
                }
                else
                {
                    Partido partido = crudPartidos.DevuelveGrupoMENOR(GrupoH);
                    crudPartidos.InsertarCuartos(partido);
            ...
            if (id_partido == 55)
            {
                ...
                if (Convert.ToInt32(cantPenales1.Text) > Convert.ToInt32(cantPenales2.Text)) //SI GANA
                {
                    Partido partido = crudPartidos.DevuelveGrupoMAYOR(GrupoF);
                    crudPartidos.InsertarCuartos(partido);
                }
                else
                {
                    Partido partido = crudPartidos.DevuelveGrupoMENOR(GrupoE);
                    crudPartidos.InsertarCuartos(partido);
            ...
            if (id_partido == 56)
            {
                ...
                if (Convert.ToInt32(cantPenales1.Text) > Convert.ToInt32(cantPenales2.Text)) //SI GANA
                {
                    Partido partido = crudPartidos.DevuelveGrupoMAYOR(GrupoH);
                    crudPartidos.InsertarCuartos(partido);
                }
                else
                {
                    Partido partido = crudPartidos.DevuelveGrupoMENOR(GrupoG);
                    crudPartidos.InsertarCuartos(partido);
        ...
        private void btnCargaEqUno_Click(object sender, EventArgs e) // CARGAR PARTIDO OCTAVO
        {
        ...
        private void ElegirPartido_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (ElegirPartido.SelectedIndex == 0) // PARTIDO [49]
            {
                //MOSTRAR PAISES
                string equipoAleatorio = "";
                string equipoAleatorio2 = "";

                equipoAleatorio = crudPartidos.DevuelveIDGrupoMAYOR(GrupoA); // ------- GRUPO A
                ...
                equipoAleatorio2 = crudPartidos.DevuelveIDGrupoMENOR(GrupoB);// ------- GRUPO B
            ...
            if (ElegirPartido.SelectedIndex == 1) // PARTIDO [50]
            {
                string equipoAleatorio = "";
                string equipoAleatorio2 = "";

                equipoAleatorio = crudPartidos.DevuelveIDGrupoMAYOR(GrupoC);// ------- GRUPO C
                ...
                equipoAleatorio2 = crudPartidos.DevuelveIDGrupoMENOR(GrupoD);// ------- GRUPO D
            ...
            if (ElegirPartido.SelectedIndex == 2) // PARTIDO [51]
            {

                string equipoAleatorio = "";
                string equipoAleatorio2 = "";

                equipoAleatorio = crudPartidos.DevuelveIDGrupoMAYOR(GrupoB);// ------- GRUPO B
                ...
                equipoAleatorio2 = crudPartidos.DevuelveIDGrupoMENOR(GrupoA);// ------- GRUPO A
            ...
            if (ElegirPartido.SelectedIndex == 3) // PARTIDO [52]
            {
                string equipoAleatorio = "";
                string equipoAleatorio2 = "";

                equipoAleatorio = crudPartidos.DevuelveIDGrupoMAYOR(GrupoD);// ------- GRUPO D
                ...
                equipoAleatorio2 = crudPartidos.DevuelveIDGrupoMENOR(GrupoC);// ------- GRUPO C
            ...
            if (ElegirPartido.SelectedIndex == 4) // PARTIDO [53]
            {
                string equipoAleatorio = "";
                string equipoAleatorio2 = "";

                equipoAleatorio = crudPartidos.DevuelveIDGrupoMAYOR(GrupoE);// ------- GRUPO E
                ...
                equipoAleatorio2 = crudPartidos.DevuelveIDGrupoMENOR(GrupoF);// ------- GRUPO F
            ...
            if (ElegirPartido.SelectedIndex == 5) // PARTIDO [54]
            {
                string equipoAleatorio = "";
                string equipoAleatorio2 = "";

                equipoAleatorio = crudPartidos.DevuelveIDGrupoMAYOR(GrupoG);// ------- GRUPO G
                ...
                equipoAleatorio2 = crudPartidos.DevuelveIDGrupoMENOR(GrupoH);// ------- GRUPO H
            ...
            if (ElegirPartido.SelectedIndex == 6) // PARTIDO [55]
            {
                string equipoAleatorio = "";
                string equipoAleatorio2 = "";

                equipoAleatorio = crudPartidos.DevuelveIDGrupoMAYOR(GrupoF);// ------- GRUPO F
                ...
                equipoAleatorio2 = crudPartidos.DevuelveIDGrupoMENOR(GrupoE);// ------- GRUPO E
            ...
            if (ElegirPartido.SelectedIndex == 7) // PARTIDO [56]
            {
                string equipoAleatorio = "";
                string equipoAleatorio2 = "";

                equipoAleatorio = crudPartidos.DevuelveIDGrupoMAYOR(GrupoH);// ------- GRUPO H
                ...
                equipoAleatorio2 = crudPartidos.DevuelveIDGrupoMENOR(GrupoG);// ------- GRUPO G
        ...
        private void btnCuartos_Click(object sender, EventArgs e)
        {
            ven_cuartos.ShowDialog();
        }
    }
}
